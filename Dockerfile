...
FROM node:alpine
LABEL org.opencontainers.image.title="nahsh-gtfs-rt-server"
LABEL org.opencontainers.image.description="Expose Schleswig-Holstein & Hamburg transit data as a GTFS-RT feed."
